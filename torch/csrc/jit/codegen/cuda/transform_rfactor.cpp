...
// Entry for backward influence propagation on td following record, history should be present -> past as you go through the vector
void TransformRFactor::replayBackward(TensorDomain* td, std::vector<Expr*> history) {
