...
auto shift(at::Tensor tensor, const std::vector<int>& offsets) {
  ...
  for (size_t i = 0; i < offsets.size(); ++i) {
    ...
    std::vector<at::indexing::TensorIndex> indices(tensor.ndimension(), Slice(0, None));
    if (offset > 0) {
...
TEST(NVFuserTest, FusionShift01_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShift02_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
#if 0
TEST(NVFuserTest, FusionShiftNoSplit1_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftSplit3_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftSplit4_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftSplit5_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftSplit6_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftSplit7_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge3_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge4_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge5_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge6_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge7_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
TEST(NVFuserTest, FusionShiftMerge8_CUDA) {
  Fusion fusion;
  FusionGuard fg(&fusion);
